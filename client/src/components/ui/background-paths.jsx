    ...
    return (
        <div className="relative min-h-[100vh] w-full flex items-center justify-center overflow-hidden bg-white dark:bg-black transition-colors duration-500 font-inter">
            ...
            <div className="relative z-10 container mx-auto px-4 md:px-6 text-center">
                ...
                >
                    <h1 className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-black mb-10 tracking-tighter leading-[0.85] font-outfit">
                    ...
                    {subtitle && (
                        <p className="text-lg md:text-xl text-neutral-500 dark:text-white/50 max-w-2xl mx-auto mb-12 font-light leading-relaxed">
                            {subtitle}
                        </p>
                    )}
