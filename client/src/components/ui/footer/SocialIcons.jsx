...
const SocialIcons = () => {
    return (
        <div className="social-icons-3d">
            <style>{`
        .social-icons-3d #svg-container {
          zoom: 1.2;
        }
        .social-icons-3d #id-repo-ghost-instagram .container-g-icons g,
        .social-icons-3d #id-repo-ghost-facebook .container-g-icons g,
        .social-icons-3d #id-repo-ghost-linkelind .container-g-icons g,
        .social-icons-3d #id-repo-ghost-twich .container-g-icons g {
          opacity: 0.5;
          transition: 0.3s ease-in-out;
        }

        .social-icons-3d #id-repo-ghost-instagram:hover .container-g-icons g,
        .social-icons-3d #id-repo-ghost-facebook:hover .container-g-icons g,
        .social-icons-3d #id-repo-ghost-linkelind:hover .container-g-icons g,
        .social-icons-3d #id-repo-ghost-twich:hover .container-g-icons g {
          opacity: 1;
        }

        .social-icons-3d #id-repo-ghost-twich,
        .social-icons-3d #id-repo-ghost-instagram,
        .social-icons-3d #id-repo-ghost-facebook,
        .social-icons-3d #id-repo-ghost-linkelind {
          cursor: pointer;
        }
        .social-icons-3d #id-03-instagram,
        .social-icons-3d #id-01-facebook,
        .social-icons-3d #id-04-linkelind,
        .social-icons-3d #id-02-twich,
        .social-icons-3d .react-path-v1,
        .social-icons-3d .react-path-v2 {
          transition: 0.5s ease-in-out;
        }

        .social-icons-3d #id-repo-ghost-instagram:hover #id-03-instagram,
        .social-icons-3d #id-repo-ghost-facebook:hover #id-01-facebook,
        .social-icons-3d #id-repo-ghost-linkelind:hover #id-04-linkelind,
        .social-icons-3d #id-repo-ghost-twich:hover #id-02-twich {
          transform: translate(0px, -10px);
        }

        .social-icons-3d #id-repo-ghost-instagram:hover .react-path-v1,
        .social-icons-3d #id-repo-ghost-facebook:hover .react-path-v1,
        .social-icons-3d #id-repo-ghost-linkelind:hover .react-path-v1,
        .social-icons-3d #id-repo-ghost-twich:hover .react-path-v1 {
          transform: translate(0px, -6px);
        }

        .social-icons-3d #id-repo-ghost-instagram:hover .react-path-v2,
        .social-icons-3d #id-repo-ghost-facebook:hover .react-path-v2,
        .social-icons-3d #id-repo-ghost-linkelind:hover .react-path-v2,
        .social-icons-3d #id-repo-ghost-twich:hover .react-path-v2 {
        ...
        .social-icons-3d #line-animation-v1 {
          animation: bounce-lines 3s infinite ease-in-out;
        }
        .social-icons-3d #line-animation-v2 {
          animation: bounce-lines 3s infinite ease-in-out;
          animation-delay: 0.2s;
        }
      `}</style>

            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 114 173" height={173} width={114} id="svg-container">
                <g>
                ...
                <g id="id-repo-ghost-instagram">
                    ...
                    <g className="container-g-icons" id="id-03-instagram">
                        ...
                        <g clipPath="url(#clip1_54_145)">
                            <path fill="white" d="M50.6788 69.8633C49.1512 70.7453 48.9662 70.8602 48.3927 71.2222C47.8206 71.585 47.5061 71.8754 47.2873 72.1627C47.0524 72.461 46.9337 72.7855 46.9397 73.1133C46.9337 73.441 47.0524 73.7655 47.2873 74.0639C47.5054 74.3507 47.8199 74.642 48.3906 75.0032C48.9655 75.3659 49.1498 75.4805 50.6796 76.3637C52.2079 77.2461 52.4063 77.3525 53.0332 77.6836C53.6609 78.0135 54.164 78.1951 54.6615 78.3214C55.1758 78.4518 55.6818 78.5221 56.308 78.5221C56.9336 78.5225 57.4402 78.4526 57.9538 78.3218C58.452 78.1951 58.9551 78.0143 59.5821 77.684C60.2097 77.3525 60.4082 77.2461 61.9372 76.3633C63.4662 75.4805 63.6499 75.3663 64.224 75.004C64.7947 74.642 65.1106 74.3507 65.3295 74.0635C65.564 73.7652 65.6824 73.4409 65.6763 73.1133C65.6763 72.7517 65.5546 72.4596 65.3287 72.1627C65.1092 71.8758 64.7954 71.585 64.224 71.2226C63.6506 70.8606 63.4662 70.7461 61.9372 69.8633C60.4082 68.9805 60.2097 68.8741 59.5821 68.5426C58.9551 68.2131 58.4506 68.0315 57.9545 67.9052C57.4377 67.7695 56.8757 67.701 56.308 67.7045C55.7404 67.701 55.1783 67.7695 54.6615 67.9052C54.1633 68.0319 53.6588 68.2135 53.0325 68.5434C52.4049 68.8749 52.2072 68.9809 50.6774 69.8641L50.6788 69.8633ZM51.189 70.7404L51.6942 70.4487C53.1972 69.5809 53.3801 69.481 54.0008 69.1544C54.5742 68.8517 54.9648 68.7327 55.2399 68.6624C55.6044 68.5698 55.9147 68.532 56.3087 68.532C56.7028 68.532 57.0117 68.5698 57.3769 68.6628C57.652 68.7323 58.0418 68.8517 58.6153 69.1544C59.2359 69.481 59.4195 69.5805 60.9218 70.4479C62.4241 71.3152 62.5972 71.4217 63.1629 71.78C63.6871 72.1111 63.8926 72.3361 64.0143 72.495C64.1675 72.6884 64.2445 72.899 64.2395 73.1117C64.2395 73.3392 64.1741 73.5175 64.0129 73.7283C63.8933 73.8868 63.6864 74.1118 63.1622 74.4438C62.5958 74.8017 62.4241 74.9081 60.9211 75.7758C59.4181 76.6436 59.2331 76.7431 58.6132 77.0702C58.039 77.3724 57.6499 77.4914 57.374 77.5613C57.0392 77.65 56.6743 77.6947 56.3059 77.6921C55.9371 77.6951 55.5718 77.6507 55.2364 77.5621C54.9619 77.4922 54.5714 77.3732 53.9979 77.0706C53.378 76.7435 53.1944 76.644 51.6907 75.7758C50.187 74.9077 50.016 74.8025 49.4496 74.4446C48.9261 74.1131 48.7192 73.888 48.5982 73.7287C48.