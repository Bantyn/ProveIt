...
export const SignInPage = ({
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        ...
        // on real API success:
        // if (res.success) { localStorage.setItem("token", res.token); navigate('/dashboard'); }
  ...
  return (
    <div className={`min-h-screen w-full flex relative overflow-hidden transition-colors duration-500 ${isDark ? "text-white" : "text-gray-900"
      }`}>
        ...
        >
          <div className={`h-full rounded-2xl border shadow-xl p-10 space-y-6 relative overflow-hidden ${isDark
            ...
            <div className="relative z-10 space-y-6">
              ...
              <form onSubmit={formik.handleSubmit} className="space-y-6" data-aos="fade-up">
                ...
                <div className="space-y-6" data-aos="fade-up">
                  ...
                  >
                    <label className="flex gap-2 items-center cursor-pointer group" htmlFor="rememberMe">
                      <input
                        id="rememberMe"
                        type="checkbox"
                        name="rememberMe"
                        ...
                        className={`w-4 h-4 cursor-pointer ${isDark ? "accent-purple-500" : "accent-purple-600"}`}
                      />
              ...
              >
                <motion.button
                  ...
                  className={`w-full flex items-center justify-center gap-3 rounded-xl py-4 border group transition-all shadow-sm ${isDark
                ...
                >
                  ...
                  <span className={`px-2 py-0.5 text-[10px] rounded-full border ${isDark
