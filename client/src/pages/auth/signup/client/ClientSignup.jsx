          ...
          <section className="hidden lg:flex flex-1 relative p-8">
            ...
            >
              ...
              <motion.div
                ...
                className={`absolute top-8 left-8 right-8 p-6 rounded-2xl backdrop-blur-xl border shadow-2xl ${isDark
            ...
            <div className={`rounded-2xl border shadow-xl p-10 space-y-6 relative overflow-hidden ${isDark
              ...
              <div className="relative z-10 space-y-6">
                ...
                <motion.div
                  ...
                  className={`relative flex items-center gap-4 text-xs uppercase tracking-wider ${isDark ? "text-gray-400" : "text-gray-500"
                    }`}
                >
                    ...
                    <div key={step} className="flex items-center">
                      <div className={`flex items-center justify-center w-10 h-10 rounded-full border-2 transition-all ${
                        currentStep === step
                          ...
                          : isDark
                          ? "border-purple-900/30 bg-transparent text-gray-500"
                      ...
                      {step < 3 && (
                        <div className={`w-12 h-0.5 mx-1 ${
                          currentStep > step
                            ...
                            : isDark ? "bg-purple-900/30" : "bg-gray-300"
                        }`} />
                      )}
                    </div>
                  ))}
                ...
                <div className="text-center">
                  <p className={`text-sm font-medium ${isDark ? "text-gray-300" : "text-gray-700"}`}>
                    ...
                    {currentStep === 3 && "Step 3: Choose Your Plan"}
                  </p>
                </div>
